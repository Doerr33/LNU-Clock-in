  ...
  return function (t) {
    ...
    (function (t) {
      ...
      c.prototype.slice = function (t, e) {
        ...
        return t = +t, e |= 0, r || T(this, t, e, 2, 65535, 0), c.TYPED_ARRAY_SUPPORT ? (this[e] = 255 & t, this[e + 1] = t >>> 8) : j(this, t, e, !0), e + 2
      }, c.prototype.writeUInt16BE = function (t, e, r) {
        return t = +t, e |= 0, r || T(this, t, e, 2, 65535, 0), c.TYPED_ARRAY_SUPPORT ? (this[e] = t >>> 8, this[e + 1] = 255 & t) : j(this, t, e, !1), e + 2
      }, c.prototype.writeUInt32LE = function (t, e, r) {
        return t = +t, e |= 0, r || T(this, t, e, 4, 4294967295, 0), c.TYPED_ARRAY_SUPPORT ? (this[e + 3] = t >>> 24, this[e + 2] = t >>> 16, this[e + 1] = t >>> 8, this[e] = 255 & t) : N(this, t, e, !0), e + 4
      }, c.prototype.writeUInt32BE = function (t, e, r) {
        return t = +t, e |= 0, r || T(this, t, e, 4, 4294967295, 0), c.TYPED_ARRAY_SUPPORT ? (this[e] = t >>> 24, this[e + 1] = t >>> 16, this[e + 2] = t >>> 8, this[e + 3] = 255 & t) : N(this, t, e, !1), e + 4
        ...
        return t = +t, e |= 0, r || T(this, t, e, 2, 32767, -32768), c.TYPED_ARRAY_SUPPORT ? (this[e] = 255 & t, this[e + 1] = t >>> 8) : j(this, t, e, !0), e + 2
      }, c.prototype.writeInt16BE = function (t, e, r) {
        return t = +t, e |= 0, r || T(this, t, e, 2, 32767, -32768), c.TYPED_ARRAY_SUPPORT ? (this[e] = t >>> 8, this[e + 1] = 255 & t) : j(this, t, e, !1), e + 2
      }, c.prototype.writeInt32LE = function (t, e, r) {
        return t = +t, e |= 0, r || T(this, t, e, 4, 2147483647, -2147483648), c.TYPED_ARRAY_SUPPORT ? (this[e] = 255 & t, this[e + 1] = t >>> 8, this[e + 2] = t >>> 16, this[e + 3] = t >>> 24) : N(this, t, e, !0), e + 4
      }, c.prototype.writeInt32BE = function (t, e, r) {
        return t = +t, e |= 0, r || T(this, t, e, 4, 2147483647, -2147483648), t < 0 && (t = 4294967295 + t + 1), c.TYPED_ARRAY_SUPPORT ? (this[e] = t >>> 24, this[e + 1] = t >>> 16, this[e + 2] = t >>> 8, this[e + 3] = 255 & t) : N(this, t, e, !1), e + 4
    ...
    (function (t) {
      ...
      e.format = function (t) {
        ...
        for (var n = arguments, i = n.length, s = String(t).replace(o, (function (t) {
          ...
          })), c = n[r]; r < i; c = n[++r]) y(c) || !w(c) ? s += " " + c : s += " " + a(c);
        return s
      ...
      function a(t, r) {
        ...
        return arguments.length >= 3 && (n.depth = arguments[2]), arguments.length >= 4 && (n.colors = arguments[3]), d(r) ? n.showHidden = r : r && e._extend(n, r), m(n.showHidden) && (n.showHidden = !1), m(n.depth) && (n.depth = 2), m(n.colors) && (n.colors = !1), m(n.customInspect) && (n.customInspect = !0), n.colors && (n.stylize = c), h(n, t, n.depth)
      }
      ...
      function h(t, r, n) {
        ...
        if (t.showHidden && (s = Object.getOwnPropertyNames(r)), k(r) && (s.indexOf("message") >= 0 || s.indexOf("description") >= 0)) return f(r);
        if (0 === s.length) {
          if (E(r)) {
            var c = r.name ? ": " + r.name : "";
        ...
        var u, w = "",
          _ = !1,
          S = ["{", "}"];
        (l(r) && (_ = !0, S = ["[", "]"]), E(r)) && (w = " [Function" + (r.name ? ": " + r.name : "") + "]");
        return b(r) && (w = " " + RegExp.prototype.toString.call(r)), A(r) && (w = " " + Date.prototype.toUTCString.call(r)), k(r) && (w = " " + f(r)), 0 !== s.length || _ && 0 != r.length ? n < 0 ? b(r) ? t.stylize(RegExp.prototype.toString.call(r), "regexp") : t.stylize("[Object]", "special") : (t.seen.push(r), u = _ ? function (t, e, r, n, o) {
          for (var i = [], s = 0, a = e.length; s < a; ++s) x(e, String(s)) ? i.push(p(t, e, r, n, String(s), !0)) : i.push("");
      ...
      function p(t, e, r, n, o, i) {
        ...
        if ((c = Object.getOwnPropertyDescriptor(e, o) || {
            value: e[o]
          }).get ? a = c.set ? t.stylize("[Getter/Setter]", "special") : t.stylize("[Getter]", "special") : c.set && (a = t.stylize("[Setter]", "special")), x(n, o) || (s = "[" + o + "]"), a || (t.seen.indexOf(c.value) < 0 ? (a = y(r) ? h(t, c.value, null) : h(t, c.value, r - 1)).indexOf("\n") > -1 && (a = i ? a.split("\n").map((function (t) {
            return "  " + t
          })).join("\n").substr(2) : "\n" + a.split("\n").map((function (t) {
            return "   " + t
      ...
      e.debuglog = function (r) {
        if (m(i) && (i = t.env.NODE_DEBUG || ""), r = r.toUpperCase(), !s[r])
        ...
        date: "magenta",
        regexp: "red"
      }, e.isArray = l, e.isBoolean = d, e.isNull = y, e.isNullOrUndefined = function (t) {
        return null == t
    ...
    class f extends n {
      constructor(t, e, r) {
        super(), c("constructor: ", t, e, r), this.readyState = f.CONNECTING, this.protocol = "", this._closeCode = 1006, this._closeMessage = "", this._binaryType = u[0], this._socket = null, this.supports = {
          binary: !0
      ...
      setSocket(t, e) {
        this._socket = t, this._sender = new a(t), c("set socket: socket =", t, ", head =", e, ", this: ", this), t.onOpen(t => {
      ...
      close(t, e) {
        if (c("closing connection: ", this.readyState), this.readyState !== f.CLOSED) {
          ...
          this.readyState !== f.CLOSING && (this.readyState = f.CLOSING, setTimeout(this._socket.close({
            code: t,
            reason: e,
            success: () => {
    ...
    function f(t, e, r, n) {
      ...
      else if ("function" == typeof s ? s = i[e] = n ? [r, s] : [s, r] : n ? s.unshift(r) : s.push(r), (o = h(t)) > 0 && s.length > o && !s.warned) {
        s.warned = !0;
    ...
    i.prototype.parse = function (t, e, r) {
      ...
      if (!g[A] && (E || A && !v[A])) {
        ...
        } - 1 !== (S = -1 === O ? b.lastIndexOf("@") : b.lastIndexOf("@", O)) && (_ = b.slice(0, S), b = b.slice(S + 1), this.auth = decodeURIComponent(_)), O = -1;
        ...
        if (!C)
          for (var R = this.hostname.split(/\./), P = (B = 0, R.length); B < P; B++) {
            var T = R[B];
            if (T && !T.match(l)) {
              for (var j = "", N = 0, L = T.length; N < L; N++) T.charCodeAt(N) > 127 ? j += "x" : j += T[N];
              if (!j.match(l)) {
                var U = R.slice(0, B),
                  I = R.slice(B + 1),
                  D = T.match(d);
        ...
        var M = this.port ? ":" + this.port : "",
          q = this.hostname || "";
        this.host = q + M, this.href += this.host, C && (this.hostname = this.hostname.substr(1, this.hostname.length - 2), "/" !== b[0] && (b = "/" + b))
      }
      if (!y[k])
      ...
      var H = b.indexOf("?");
      if (-1 !== H ? (this.search = b.substr(H), this.query = b.substr(H + 1), e && (this.query = m.parse(this.query)), b = b.slice(0, H)) : e && (this.search = "", this.query = {}), b && (this.pathname = b), v[k] && this.hostname && !this.pathname && (this.pathname = "/"), this.pathname || this.search) {
        M = this.pathname || "";
        var J = this.search || "";
        this.path = M + J
      }
      ...
      var b = r.pathname && "/" === r.pathname.charAt(0),
        ...
        _ = (d = t.pathname && t.pathname.split("/") || [], r.protocol && !v[r.protocol]);
      if (_ && (r.hostname = "", r.port = null, r.host && ("" === E[0] ? E[0] = r.host : E.unshift(r.host)), r.host = "", t.protocol && (t.hostname = null, t.port = null, t.host && ("" === d[0] ? d[0] = t.host : d.unshift(t.host)), t.host = null), A = A && ("" === d[0] || "" === E[0])), w) r.host = t.host || "" === t.host ? t.host : r.host, r.hostname = t.hostname || "" === t.hostname ? t.hostname : r.hostname, r.search = t.search, r.query = t.query, E = d;
      else if (d.length) E || (E = []), E.pop(), E = E.concat(d), r.search = t.search, r.query = t.query;
      else if (!o.isNullOrUndefined(t.search)) {
        if (_) r.hostname = r.host = E.shift(), (C = !!(r.host && r.host.indexOf("@") > 0) && r.host.split("@")) && (r.auth = C.shift(), r.host = r.hostname = C.shift());
      ...
      for (var S = E.slice(-1)[0], O = (r.host || t.host || E.length > 1) && ("." === S || ".." === S) || "" === S, B = 0, x = E.length; x >= 0; x--) "." === (S = E[x]) ? E.splice(x, 1) : ".." === S ? (E.splice(x, 1), B++) : B && (E.splice(x, 1), B--);
      if (!A && !k)
        for (; B--; B) E.unshift("..");
      !A || "" === E[0] || E[0] && "/" === E[0].charAt(0) || E.unshift(""), O && "/" !== E.join("/").substr(-1) && E.push("");
      var C, R = "" === E[0] || E[0] && "/" === E[0].charAt(0);
      _ && (r.hostname = r.host = R ? "" : E.length ? E.shift() : "", (C = !!(r.host && r.host.indexOf("@") > 0) && r.host.split("@")) && (r.auth = C.shift(), r.host = r.hostname = C.shift()));
      return (A = A || r.host && E.length) && !R && E.unshift(""), E.length ? r.pathname = E.join("/") : (r.pathname = null, r.path = null), o.isNull(r.pathname) && o.isNull(r.search) || (r.path = (r.pathname ? r.pathname : "") + (r.search ? r.search : "")), r.auth = t.auth || r.auth, r.slashes = r.slashes || t.slashes, r.href = r.format(), r
    ...
    (function (t, n) {
      ...
      ! function (i) {
        ...
        function k(t) {
          ...
          for (o = r > 0 ? r + 1 : 0; o < g;) {
            for (i = v, s = 1, a = 36; o >= g && y("invalid-input"), ((u = (p = t.charCodeAt(o++)) - 48 < 10 ? p - 22 : p - 65 < 26 ? p - 65 : p - 97 < 26 ? p - 97 : 36) >= 36 || u > l((c - v) / s)) && y("overflow"), v += u * s, !(u < (h = a <= w ? 1 : a >= w + 26 ? 26 : a - w)); a += 36) s > l(c / (f = 36 - h)) && y("overflow"), s *= f;
        ...
        function E(t) {
          var e, r, n, o, i, s, a, u, h, f, p, g, v, b, k, E = [];
          for (g = (t = m(t)).length, e = 128, r = 0, i = 72, s = 0; s < g; ++s)(p = t[s]) < 128 && E.push(d(p));
          for (n = o = E.length, o && E.push("-"); n < g;) {
            ...
            for (a - e > l((c - r) / (v = n + 1)) && y("overflow"), r += (a - e) * v, e = a, s = 0; s < g; ++s)
              if ((p = t[s]) < e && ++r > c && y("overflow"), p == e) {
                for (u = r, h = 36; !(u < (f = h <= i ? 1 : h >= i + 26 ? 26 : h - i)); h += 36) k = u - f, b = 36 - f, E.push(d(w(f + k % b, 0))), u = l(k / b);
    ...
    t.exports = function (t, e, r, i) {
      ...
      c > 0 && u > c && (u = c);
      for (var h = 0; h < u; ++h) {
        var f, p, l, d, y = t[h].replace(a, "%20"),
          g = y.indexOf(r);
